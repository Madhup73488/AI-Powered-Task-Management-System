    ...
    const fetchData = async () => {
      try {
        ...
        if (!taskData) {
          ...
          alert("Task not found or you don't have permission to view it");
          router.push("/mytasks");
          return;
        }
        if (taskData) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          >
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p
                  className={`mt-1 ${darkMode ? "text-white" : "text-gray-900"}`}
                >
                  {task.description}
                </p>
              </div>
              ...
              <div>
                <label
                  className={`text-sm font-medium flex items-center gap-2 ${darkMode ? "text-gray-400" : "text-gray-600"}`}
                >
                  <Calendar size={16} />
                  Deadline
                </label>
          ...
          >
            <CardHeader>
              <CardTitle
                className={`text-lg flex items-center gap-2 ${darkMode ? "text-white" : "text-gray-900"}`}
              >
                <FileText size={18} />
            ...
            <CardContent className="space-y-4">
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <div className="mb-2">
                            <p
                              className={`text-sm font-medium ${isOwnComment || darkMode ? "text-white" : "text-gray-900"}`}
                            >
                              {isOwnComment
                                ? "You"
                            ...
                            <p
                              className={`text-xs ${isOwnComment ? "text-blue-50" : darkMode ? "text-gray-400" : "text-gray-500"}`}
                            >
                              {new Date(comment.created_at).toLocaleString()}
                            </p>
                          </div>
                          <p
                            className={`text-sm whitespace-pre-wrap ${isOwnComment ? "text-white" : darkMode ? "text-gray-300" : "text-gray-700"}`}
                          >
                            {comment.comment}
                          </p>
                        </div>
              ...
              {/* Add Comment Form */}
              <div
                className={`border-t pt-4 ${darkMode ? "border-gray-800" : "border-gray-200"}`}
              >
                <Textarea
          ...
          >
            ...
            <CardContent className="space-y-4">
              <Select value={status} onValueChange={setStatus}>
                ...
                >
                  <SelectItem
                    className={`${darkMode ? "hover:bg-gray-800 focus:bg-gray-800" : "hover:bg-gray-100 focus:bg-gray-100"}`}
                    value="not_picked"
                  >
                    Not Picked
                  </SelectItem>
